...
const NewContract: React.FC<Props> = ({ onCancel }) => {
    ...
    const [clients, setClients] = useState<Client[]>([
        { id: '1', firstName: 'John', lastName: 'Doe', email: 'john@doe.org', address: 'org', phone: '04748732', userId: '1' },
        { id: '2', firstName: 'Jane', lastName: 'Smith', email: 'jane@smith.com', address: 'com', phone: '09832742', userId: '2' }
    ]);
        ...
        <div className="p-4">
            ...
            <form onSubmit={postContract} className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
                ...
                <FormControl fullWidth margin="normal" error={!!errs.typeErr}>
                    ...
                    {errs.typeErr && <p className="text-red-500 text-xs italic">{errs.typeErr}</p>}
                </FormControl>
                ...
                <FormControl fullWidth margin="normal" error={!!errs.clientIdErr}>
                    ...
                    {errs.clientIdErr && <p className="text-red-500 text-xs italic">{errs.clientIdErr}</p>}
                </FormControl>
