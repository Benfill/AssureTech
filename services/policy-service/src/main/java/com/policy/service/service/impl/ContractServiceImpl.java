...
//	    CustomerResponse customerResponse = CustomerResponse.builder().build();
	    ...
	    throw new ResourceAlreadyExistsException("Contract already exists.");
	}
    }
	...
	if (foundContract.isPresent()) {
	    ...
	    throw new ResourceNotFoundException("No Contract was Found.");
	}
    }
	...
	if (this.repository.existsById(id)) {
		...
		throw new GeneralException("Failed deleting contract claims.");
	    }
